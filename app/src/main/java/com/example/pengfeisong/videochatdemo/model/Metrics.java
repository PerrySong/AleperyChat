...
public enum Metrics {
    ...
    public static int numberOfEmotions() {
        return ATTENTION.ordinal();
    }

    public static int numberOfExpressions() {
    ...
    public static int numberOfQualities() {
    ...
    */
    public static Metrics[] getExpressions() {
     ...
     */
    public static Metrics[] getMeasurements() {
     ...
     */
    public static Metrics[] getAppearances() {
 ...
 */
    public static Metrics[] getQualities() {
